...
static bool ValidateCertificateCallback(object sender, X509Certificate? certificate, X509Chain? chain, SslPolicyErrors sslPolicyErrors)
{
    Console.WriteLine("Server certificate: {0}", certificate.ToString());
    return true;
}

// var cert = new X509Certificate2("C:\\Users\\lrbakken\\development\\rabbitmq\\rabbitmq-dotnet-client\\projects\\Applications\\GH-1864\\certs\\client_and_ca.pfx");
var cert = new X509Certificate2(".\\certs\\client.pfx");
var x509Certificates = new X509CertificateCollection
{
    cert
};

SslOption sslOption = new()
{
    ...
    CertificateValidationCallback = ValidateCertificateCallback
};
